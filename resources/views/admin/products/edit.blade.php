...
@section('content')
    ...
    <div class="modal fade" id="modalMedicaluse" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog medicin-model" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Medical For</h5>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-3">
                            <input type="radio" id="treatment" name="medicine_for" value="treatment of" @if (old('medicine_for') == 'treatment of') {{ 'checked' }} @endif>
                            <label for="treatment">Treatment of</label>
                        </div>
                        <div class="col-md-3">
                            <input type="radio" id="usedin" name="medicine_for" value="used in" @if (old('medicine_for') == 'used in') {{ 'checked' }}@endif>
                            <label for="usedin">Used In</label>
                        </div>
                        <div class="col-md-3">
                            <input type="radio" id="usedas" name="medicine_for" value="used as" @if (old('medicine_for') == 'used as') {{ 'checked' }} @endif>
                            <label for="usedas">Used As</label>
                        </div>
                        <div class="col-md-3">
                            <input type="radio" id="support" name="medicine_for" value="support" @if (old('medicine_for') == 'support') {{ 'checked' }} @endif>
                ...
                <div class="modal-body  medi-uses">
                    <div class="row">
                        @php
                            // $medicine_use_array = [];
                            // $medicine_use_array = explode(',', $product->medicine_use);
                            // (empty(old('medicine_use')) && in_array($medicine_use->id, $medicine_use_array) ? 'checked' : '')
                        @endphp
                        @csrf
                        @foreach ($medicine_uses as $medicine_use)
                            <div class="col-md-6">
                                <div class="p-2 rounded checkbox-form">
                                    <div class="form-check"> <input class="form-check-input" name='medicine_use' type="checkbox" value="{{ $medicine_use->id }}" data-name="{{ $medicine_use->name }}" {{ !empty(old('medicine_use')) && in_array($medicine_use->id, old('medicine_use')) ? 'checked' : '' }}> <label class="form-check-label">{{ $medicine_use->name }}</label> </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        {{-- <div class="col-xs-8 col-sm-8 col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" name="tagline" id="tagline" class="form-control" placeholder="Tag Line about Product" value="{{ $product->tagline }}">
                            </div>
                        </div> --}}
                        <div class="col-xs-8 col-sm-8 col-md-8">
                            <div class="form-group">
                                ...
                                <select name="producttype" id="producttype" class="form-control">
                                    @foreach ($parentCategories as $parentCategories_row)

                                        <option {{ (old('producttype')==$parentCategories_row->id)?"selected": (($product->producttypeid==$parentCategories_row->id)?"selected":'')}} value="{{ $parentCategories_row->id }}" >{{ $parentCategories_row->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-8 col-sm-8 col-md-8">
                            <div class="form-group">
                                ...
                                <div class="card-body category-list-block">
                                    @foreach ($parentsubCategories as $category)
                                        <ul>
                                            <li><a href="javascript:void(0)" id="category" data_item="{{ $category->id }}" class="category_items {{ $category->id == $product->category_id ? 'active' : '' }}">{{ $category->name }}</a></li>
                                            @if (count($category->subcategory))
                                                @include('admin.category.subCategoryListProductEdit',['subcategories' => $category->subcategory])
                                            @endif
                                        </ul>
                                    @endforeach

                                </div>
                                <input type="hidden" name="selected_category" value="{{ $product->category_id }}" id="selected_category">
                            </div>
                        </div>
                        ...
                        <div class="col-xs-8 col-sm-8 col-md-8">
                            <div class="form-group">
                                ...
                                <div id="product_content_selected">
                                    @if ((!empty(old('product_contents')) && old('product_contents.0') != '') || $errors->any())
                                    @if (!empty(old('product_contents')))
                                        ...
                                        @endforeach
                                    @endif
                                @elseif ($product_contents)
                                    @foreach ($product_contents as $value)
                                        <div class="contents_added">{{ $value->name }}<input type="hidden" name="product_contentname[]" value="{{ $value->name }}" /><input type="hidden" name="product_contents[]" value="{{ $value->id }}"><a href="javascript:void(0)" class="remove_productcontents"><i class="fas fa-times-circle"></i></a></div>
                                    @endforeach
                                    @endif
                                </div>
                            </div>
                        ...
                        <div class="col-xs-8 col-sm-8 col-md-8">
                            <div class="form-group">
                                <label for="product_content">Products Content</label>
                        ...
                        <div class="col-xs-8 col-sm-8 col-md-8">
                            <div class="form-group">
                                ...
                                <textarea name="description" id="product_description" class="form-control">{{ $product->description }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-8 col-sm-8 col-md-8">
                            <div class="form-group">
                                ...
                                <textarea name="side_effects" id="side_effects" class="form-control">{{ $product->side_effects }}</textarea>
                            </div>
                        </div>
                        ...
                        {{-- <div class="col-xs-8 col-sm-8 col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" name="medicine_use" id="medicine_use" value="{{ old('medicine_use') != '' ? old('medicine_use') : ($product->medicine_use_name != '' ? $product->medicine_use_name : '') }}" placeholder="Enter Medicine Use" class="form-control" data-toggle="collapse" data-target="#collapse_medicine_use" aria-expanded="false" aria-controls="collapse_medicine_use" autocomplete="off">
                            </div>
                                ...
                                <div id="medical_uses_selected">
                                    @if (!empty(old('medicine_uses')) && old('medicine_uses.0') != '')
                                        @foreach (old('medicine_uses') as $key => $value)
                                            ...
                                            <div class="medicaluse_added">{{ old('medical_uses_name.' . $key) }}<input type="hidden" name="medical_uses_name[]" value="{{ old('medical_uses_name.' . $key) }}" /><input type="hidden" name="medicine_uses[]" value="{{ $value }}" /><a href="javascript:void(0)" class="remove_medicine_uses"><i class="fas fa-times-circle"></i></a></div>
                                        @endforeach
                                    @endif
                        ...
                        <div class="col-xs-8 col-sm-8 col-md-8">
                            <div class="form-group">
                                <label><b>Selected Medicine Uses:</b></label>
                                <div id="medical_uses_selected">
                                    @if ((!empty(old('medicine_uses')) && old('medicine_uses.0') != '') || (!empty(old('medicine_uses')&&$errors->any())))

                                        @foreach (old('medicine_uses') as $key => $value)

                                            <div class="medicaluse_added">{{ old('medicine_uses_for.' .$key ) }} {{ old('medicine_uses_name.' . $key) }}<input type="hidden" name="medicine_uses_name[]" value="{{ old('medicine_uses_name.' . $key) }}" /><input type="hidden" name="medicine_uses_for[]" value="{{ old('medicine_uses_for.' .$key ) }}" /><input type="hidden" name="medicine_uses[]" value="{{ $value }}" /><a href="javascript:void(0)" class="remove_medicine_uses"><i class="fas fa-times-circle"></i></a></div>
                                        @endforeach


                                @elseif($sel_medicine_uses)
                                    @foreach ($sel_medicine_uses as  $value)
                                    {{-- {{$sel_medicine_uses}} --}}
                                        <div class="medicaluse_added">{{ $value->medicine_for }} {{ $value->name }}<input type="hidden" name="medicine_uses_name[]" value="{{ $value->name }}" /><input type="hidden" name="medicine_uses_for[]" value="{{ $value->medicine_for }}" /><input type="hidden" name="medicine_uses[]" value="{{$value->medicine_for.'_'.$value->medicine_use }}" /><a href="javascript:void(0)" class="remove_medicine_uses"><i class="fas fa-times-circle"></i></a></div>
                                    @endforeach
                                    @endif
                                </div>
                            </div>
                        ...
                        <div class="col-xs-8 col-sm-8 col-md-8">
                            <div class="row">
                                <div class="col-xs-12 col-sm-4 col-md-4 form-group">
                                    ...
                                    <input type="text" name="productquantity" id="productquantity" class="form-control" value="{{ old('productquantity') != '' ? old('productquantity') : $product->quantity }}" placeholder="Quantity" />
                                </div>
                                <div class="col-xs-12 col-sm-4 col-md-4 form-group">
                                    <label for="productprice"><strong>Price</strong><span class="text-danger">*</span></label>
                                    <input type="text" name="productprice" id="productprice" class="form-control" value="{{ old('productprice') != '' ? old('productprice') : $product->price }}" placeholder="Price" />
                                </div>
                                <div class="col-xs-12 col-sm-4 col-md-4 form-group">
                                    <label for="productofferprice"><strong>Offer Price</strong></label>
                                    <input type="text" name="productofferprice" id="productofferprice" class="form-control" value="{{ old('productofferprice') != '' ? old('productofferprice') : $product->offer_price }}" placeholder="Offer" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-8 col-sm-8 col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" name="product_pack" id="product_pack" value="{{ old('product_pack') != '' ? old('product_pack') : ($product->product_pack != '' ? $product->product_pack : '') }}" placeholder="Enter Product Pack" class="form-control" autocomplete="off">
                            </div>
                        </div>
                        ...
                        <div class="col-xs-8 col-sm-8 col-md-8">
                            <div class="form-group">
                                ...
                                <textarea name="features" class="form-control" placeholder="Brief Features">{{ $product->features }}</textarea>
                            </div>
                        </div>
                      ...
                      <div class="col-xs-8 col-sm-8 col-md-8" id='productbrand'>
                            <div class="form-group">
                                ...
                                <input type="text" name="brand" id="brand" placeholder="Search Brand" class="form-control" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample" value="{{ $product->brand_name }}" autocomplete="off">
                            </div>
                            <div class="collapse" id="collapseExample"></div>
                            <input type="hidden" name="selected_brand" value="{{ $product->brands }}" id="selected_brand">
                        ...
                        <div class="col-xs-8 col-sm-8 col-md-8">
                            <div class="form-group">
                                ...
                                <div id="product_supplier_selected">
                                    @if ((!empty(old('supplier')) && old('supplier.0') != '') || $errors->any())
                                    @if (!empty(old('supplier')))
                                        ...
                                        @endforeach
                                    @endif
                                @elseif($product_suppliers)
                                    @foreach ($product_suppliers as $key => $value)
                                        <div class="suppliers_added">{{ $value->name }}<input type="hidden" name="product_suppliername[]" value="{{ $value->name }}" /><input type="hidden" name="supplier[]" value="{{ $value->id }}" /><a href="javascript:void(0)" class="remove_productsupplier"><i class="fas fa-times-circle"></i></a></div>
                                    @endforeach
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="manufacturer" id="manufacturer" class="form-control">
                                    ...
                                    @foreach ($manufacturers as $row)
                                        <option {{ ($product->manufacturer == $row->id)?'selected': ((old('manufacturer') == $row->id)?'selected':'')}}  value="{{ $row->id }}">{{ $row->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-8 col-sm-8 col-md-8">
                            <div class="form-group">
                                <label>Choose Product Variants</label>
                                <div id="product_variants_selected">
                                    @if ($variant_products)
                                        @foreach ($variant_products as $variant)
                                            <div class="variants_added">{{ $variant->product_name }}<input type="hidden" name="variants[]" value="{{ $variant->id }}"><a href="javascript:void(0)" class="remove_variant"><i class="fas fa-times-circle"></i></a></div>
                                        @endforeach
                                    @endif
                                </div>
                            </div>
                        ...
                        <div class="col-xs-8 col-sm-8 col-md-8">
                            <div class="form-group">
                                <label>Type Product Variant</label>
                                <input type="text" name="variant" id="variant" placeholder="Enter variant" class="form-control" autocomplete="off">
                            </div>
                        ...
                        <div class="col-xs-8 col-sm-8 col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" name="storage" id="storage" class="form-control" placeholder="eg: below 30" value="{{ $product->storage }}">
                            </div>
                        </div>
                        ...
                        @if ($Taxes->isNotEmpty())
                            @php
                                $tax_array = [];
                                $tax_array = explode(',', $product->tax_ids);
                            @endphp
                            <div class="col-xs-8 col-sm-8 col-md-8">
                                <strong>Choose Tax</strong>
                                <div class="form-group">
                                    @foreach ($Taxes as $Taxes_row)
                                        <input type="checkbox" id="{{ $Taxes_row->tax_name }}" name="taxes[]" value="{{ $Taxes_row->id }}" {{ !empty(old('taxes')) && in_array($Taxes_row->id, old('taxes')) ? 'checked' : (empty(old('taxes')) && in_array($Taxes_row->id, $tax_array) ? 'checked' : '') }}>
                        ...
                        <div class="col-xs-8 col-sm-8 col-md-8">
                            <div class="form-group">
                                <input type="checkbox" id="need_prescription" name="need_prescription" value="1" {{ $product->prescription == 1 ? 'checked' : '' }}>
                        ...
                        @if ($product_thumbnail->isNotEmpty())
                            ...
                            <div class="col-xs-8 col-sm-8 col-md-8">
                                ...
                                <div class="row">
                                    @foreach ($product_thumbnail as $items)
                                        <div class="col-xs-3 col-sm-3 col-md-3" id="outer_media_{{ $items->id }}">
                                            <img src="{{ asset('assets/uploads/products/') }}/{{ $items->product_image }}" alt="{{ $items->product_image }}" width="200px" />
                                            <div id="set_thumb_outer_{{ $items->id }}">
                                                @if ($items->id == $product->thumbnail)<i class="fas fa-check"></i> Thumbnail @else <a href="javascript:void(0)" onclick="setThumbnail({{ $product->id }},{{ $items->id }})">Set as Thumbnail</a>@endif
                                            </div>
                        ...
                        <div class="col-xs-8 col-sm-8 col-md-8">
                            <div class="form-group">
                                ...
                                <div class="input-group control-group increment" required>
                                    ...
                                    Thumbnail:<input type="radio" class="make_thumnail" name="thumbnail[]" value="yes">
                            ...
                            <div class="col-xs-8 col-sm-8 col-md-8">
                                <div class="form-group">
                                    <input type="checkbox" id="not_for_sale" name="not_for_sale" value="1" {{ $product->not_for_sale == 1 ? 'checked' : '' }}>
                                    <label for="not_for_sale" class="text-danger"><strong>Check if this Product not for online sale</strong></label>
                                </div>
                            </div>

                            <div class="col-xs-8 col-sm-8 col-md-8">
                                <div class="form-group">
                                    <input type="checkbox" id="hide_from_site" name="hide_from_site" value="1" {{ $product->hide_from_site == 1 ? 'checked' : '' }}>
                                    <label for="hide_from_site" class="text-danger"><strong>Check if this Product hide from website</strong></label>
                                </div>
                            </div>
...
tinymce.init({
        ...
        $(document).ready(function() {
            var parent_cat_id = $('#producttype').val();
            var product_id = {{ $product->id }}
            var old_parent_cat_id = {{ !empty(old('producttype')) && old('producttype') != '' ? old('producttype') : 0 }};
            var selected_sub_cat_id = {{ !empty(old('selected_category')) && old('selected_category') != '' ? old('selected_category') : 0 }};
            var cat_name = $('#producttype').find('option:selected').text();
                if(cat_name=="All Medicines"){
                    $('#productbrand').hide();
                    $('#brand').val('');
                }
            $.ajax({
                url: "{{ route('product.edit_subcategory') }}",
                type: "POST",
                data: {
                    parent_cat_id:parent_cat_id,
                    product_id:product_id,
                    old_parent_cat_id: old_parent_cat_id,
                ...
                success: function(data) {
                    if (data) {
                        $('.category-list-block').html(data.html);
                    } else {
        ...
        $("#select_medical_uses").click(function() {
            ...
            if ((values != '') && (typeof med_for == "undefined")) {
                swal('Please choose medicine for option');
                exit;

            }
            if ((!$("input[name='medicine_use']").is(":checked")) && (typeof med_for != "undefined")) {

                swal('Please choose medicine uses');
                exit;
            }
            ...
            $.each($("input[name='medicine_use']:checked"), function() {
        ...
        function select_variants(id, name) {
            ...
            if (allow) {
                ...
                alert('The product variant exist. Please choose other.');
            }
        ...
        function setThumbnail(cid, image_id) {
            if (cid) {
                var outerhtml = $("#set_thumb_outer_" + image_id).html();
                $("#set_thumb_outer_" + image_id).html('<img src="{{ asset('img/ajax-loader.gif') }}" >')
                $.ajax({
                    type: "post",
                    data: {
                        id: cid,
                    ...
                    url: "{{ route('products.setThumbnail') }}", //Please see the note at the end of the post**
                    success: function(res) {
                        if (res.ajax_status == 'success') {
                            ...
                            $("#set_thumb_outer_" + image_id).html(outerhtml);
                        }
                    }
        ...
        function removeMedia(cid) {
            if (confirm('Are you sure do you want to delete image?')) {
                if (cid) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('products.removeMedia') }}", //Please see the note at the end of the post**
                        success: function(res) {
                            if (res.ajax_status == 'success') {
                                html = '';
        ...
        $(document).on("click", ".remove_medicine_uses", function() {
