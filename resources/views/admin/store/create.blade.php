    ...
    <div class="card-body">
        <a class="btn btn-primary btn-circle btn-lg" href="{{ route('admin.stores') }}" title="{{ __('messages.Back to Listings') }}" style="background-color: #36b9cc"> <i class="fa fa-arrow-left" aria-hidden="true"></i></a>
            ...
            <div class="row">
                ...
                <div class="col-xs-8 col-sm-8 col-md-8">
                    <div class="form-group">
                        <strong>Location </strong> <input type="text" name="location" value="{{ old('location') }}"  class="form-control">
                    </div>
                </div>
                <div class="col-xs-8 col-sm-8 col-md-8">
                    <div class="form-group">
                        <strong>Address </strong> <textarea name="address" class="form-control">{{ old('address') }}</textarea>
                    </div>
                </div>
                <div class="col-xs-8 col-sm-8 col-md-8">
                    <div class="form-group">
                        <strong>Contact Number </strong> <input type="text" name="contact_number" value="{{ old('contact_number') }}"  class="form-control">
                    </div>
                </div>

                <div class="col-xs-8 col-sm-8 col-md-8">
                    <div class="form-group">
                        <strong>Map Location </strong> <textarea name="map_location" class="form-control">{{ old('map_location') }}</textarea>
                    </div>
                </div>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/tinymce/5.2.2/tinymce.min.js"></script>
  <script>tinymce.init({ selector:'textarea#mytextarea',
