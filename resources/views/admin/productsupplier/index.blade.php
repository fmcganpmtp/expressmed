        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <a href="{{ route('supplier.create') }}" class="btn btn-success btn-circle btn-lg"><i class="fas fa-plus"></i></a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('supplier.destroy', $row->id) }}" method="POST">
                                            <a class="btn btn-warning btn-circle btn-md" href="{{ route('supplier.edit', $row->id) }}"><i class="fas fa-pen"></i></a>
                                            @csrf
                                            <button type="submit" class="btn btn-danger btn-circle btn-md" onclick="return confirm('Do you really want to delete supplier?')"><i class="fas fa-trash"></i></button>
                                        </form>
                                    </td>
                                </tr>
                            @empty
