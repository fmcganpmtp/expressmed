...
<head>
    ...
    <title>Medcliq - Customer Support</title>
...
<body id="page-top">
    <div id="wrapper">
        @include('layouts.customersupport.cs_sidebar')
        <div id="content-wrapper" class="d-flex flex-column">

            <!-- Main Content -->
            <div id="content">
                @include('layouts.customersupport.cs_topbar')
                @yield('content')
            </div>
            @include('layouts.customersupport.cs_footer')
        </div>
    </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="{{ route('customersupport.logout') }}">Logout</a>
                </div>
            </div>
        </div>
    </div>
