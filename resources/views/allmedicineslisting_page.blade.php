    ...
    <div class="width-container">
        <nav aria-label="breadcrumb cart-page-outer">
            <ol class="breadcrumb inner-breadcrumb">
                ...
                <li class="breadcrumb-item inner-breadcrumb-dtls"><a href="{{ route('list.all-medicines') }}">All Medicines</a></li>
        ...
        <div class="row">
            ...
            <div class="col-md-12 product-listing-page-outer">
                ...
                <div class="listing-page-head d-flex justify-content-between">
                    <h2>{{ isset(request()->route()->parameters['categoryname'])? request()->route()->parameters['categoryname']: 'All Medicines' }}</h2>
                    @if (count($products) > 0)
                    {{-- @php print_r(($products->currentPage() - 1) * count($products) + 1); @endphp --}}
                                    ...
                                    <div class="col-lg-2 col-sm-4 col-6 products-content-outer">
                                        <div class="products-content">
                                            ...
                                            @if ($products_row->offer_price != 0)
                                                ...
                                                @endif
                                            @endif
                                            {{-- <div class="row product-incre-decre-outer sec_productadd">
                                                ...
                                                <div class="add-buy-cart add-to-cart-list">
                                                    <button class="btn add-cart" value="{{ $products_row->id }}">Add to Cart</button>
                                                </div>
                                            </div> --}}
